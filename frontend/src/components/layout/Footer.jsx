            ...
            <div className="max-w-[1700px] mx-auto px-6 sm:px-10 lg:px-20 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 items-start pb-24 lg:pb-32">
                    ...
                    <div className="lg:col-span-6 space-y-12">
                        <Link to="/" className="flex items-center gap-5 group">
                            ...
                            <div className="flex flex-col">
                                <span className="text-lg font-black tracking-[0.2em] text-primary uppercase group-hover:text-accent transition-colors">MHCV</span>
                                <span className="text-[9px] font-black tracking-[0.5em] text-primary/30 uppercase">Software Engineer & Solutions Architect</span>
                            </div>
                        </Link>
                        <p className="text-xl font-medium text-primary/40 leading-tight max-w-lg tracking-tight">
                            Engineering scalable software systems and cloud architectures to drive enterprise innovation.
                        </p>
                    ...
                    <div className="lg:col-span-3 space-y-10">
                        ...
                        <div className="grid grid-cols-1 gap-5">
                            <Link to="/about" className="text-xs font-black text-primary/40 hover:text-accent tracking-widest uppercase transition-all hover:translate-x-2">About Me</Link>
                            <Link to="/skills" className="text-xs font-black text-primary/40 hover:text-accent tracking-widest uppercase transition-all hover:translate-x-2">Technical Matrix</Link>
                            <Link to="/projects" className="text-xs font-black text-primary/40 hover:text-accent tracking-widest uppercase transition-all hover:translate-x-2">Portfolio</Link>
                            <Link to="/education" className="text-xs font-black text-primary/40 hover:text-accent tracking-widest uppercase transition-all hover:translate-x-2">Credentials</Link>
                            <Link to="/certificates" className="text-xs font-black text-primary/40 hover:text-accent tracking-widest uppercase transition-all hover:translate-x-2">Certifications</Link>
                        </div>
                    </div>

                    {/* Support & Services Node */}
                    <div className="lg:col-span-3 space-y-10">
                        <h4 className="text-[10px] font-black uppercase tracking-[0.6em] text-primary/20 flex items-center gap-3">
                            <div className="w-1 h-3 bg-accent" />
                            Support Protocol
                        ...
                        <div className="space-y-6">
                            <p className="text-xs font-bold text-primary/50 leading-relaxed uppercase tracking-widest">
                                3–6 Months Post-Delivery Support included for all software deployments.
                            </p>
                            <div className="space-y-3">
                                <div className="text-[9px] font-black text-primary/40 uppercase tracking-[0.3em] flex items-center gap-2">
                    ...
                    <div className="lg:col-span-3 space-y-10">
                        ...
                        <div className="flex flex-wrap gap-5">
                            {[
                                { icon: Linkedin, href: "https://linkedin.com/in/hemachandravijay-m-vijay-101674268", label: "LinkedIn" },
                                { icon: Github, href: "https://github.com/MHEMACHANDRAVIJAY", label: "GitHub" },
                                { icon: Mail, href: "mailto:mhemachandravijay347@gmail.com", label: "Email" }
                            ].map((social, idx) => (
                                <a
                                    key={idx}
                                    href={social.href}
                ...
                <div className="pt-16 lg:pt-24 border-t border-primary/5 flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <p className="text-[10px] font-black text-primary/20 uppercase tracking-[0.5em] order-first md:order-last">
                        &copy; {new Date().getFullYear()} MHCV <span className="text-accent/40 mx-2">•</span> Integrated Architecture
                    </p>
                </div>
            </div>
        </footer>
